...
- After each training session, create compliance package:
  ...
  - Compliance summary report (auto-generated PDF):
    ...
    - Supervisor vs non-supervisor count
    - Attendance rate
    - Certificate list
...
2. Upcoming Training Sessions (table)
   Columns: Date, Client, Type (Supervisor/Employee), Attendees, Status
   Sample data:
   - Feb 15, 2026 | Button Nose Grooming | Supervisor | 15 employees | Scheduled
   - Feb 20, 2026 | ABC Corp | Employee | 30 employees | Scheduled

3. Recent Activity (timeline)
   - Feb 1: Generated 50 certificates for Button Nose Grooming
...
4. Add/Edit Employee Form:
   ...
   - Job Title*, Department*, Hire Date*
   - Supervisor Status* (toggle switch)
