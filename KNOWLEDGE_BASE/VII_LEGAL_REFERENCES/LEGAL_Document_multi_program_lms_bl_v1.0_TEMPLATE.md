...
- [POSITION] vs. employee distinction
...
```
┌──────────────────────────────────────────────────────────┐
│  [COMPANY NAME] - Compliance Overview             │
├──────────────────────────────────────────────────────────┤
│                                                           │
│  ┌─────────────────────┬─────────────────────┐          │
│  │ Harassment          │ Violence            │          │
...
```
┌──────────────────────────────────────────────────────────┐
│  Compliance Documents - [COMPANY NAME]             │
├──────────────────────────────────────────────────────────┤
│                                                           │
...
```
┌──────────────────────────────────────────────────────────┐
│  Violent Incident Log - [COMPANY NAME]             │
...
│                                                           │
│  ┌────────────────────────────────────────────────────┐  │
│  │ VI-2026-001  │  [DATE]  │  Type 2  │  Closed   │  │
│  ├────────────────────────────────────────────────────┤  │
│  │ Location: Front Desk                               │  │
...
**Individual Programs:**
- Harassment Prevention: [AMOUNT] initial + [AMOUNT]/year renewal
- Workplace Violence: [AMOUNT] initial + [AMOUNT]/year renewal

**Bundle Discounts:**
- **Complete Compliance Bundle** (HPP + WVPP): [AMOUNT] initial (save [AMOUNT])
- **Tri-Program Bundle** (HPP + WVPP + IIPP): [AMOUNT] initial (save [AMOUNT])

**Monthly Retainer Tiers:**
- Basic (1 program): [AMOUNT]-800/mo
- Professional (2 programs): [AMOUNT]-1,500/mo
- Enterprise (3+ programs): [AMOUNT]-3,000/mo
...
- [ ] Test with [COMPANY NAME] (pilot both programs)
...
- 10 clients × [AMOUNT] initial = [AMOUNT]
- 10 clients × [AMOUNT]/year renewal = [AMOUNT]/year
- **Total Year 1:** [AMOUNT]

**Multi-Program (v2.0 - Harassment + Violence):**
- 10 clients × [AMOUNT] bundle initial = [AMOUNT]
- 10 clients × [AMOUNT]/year combined renewals = [AMOUNT]/year
- **Total Year 1:** [AMOUNT] (+48% increase)

**With Retainer Conversions:**
- 6 clients convert to Professional tier ([AMOUNT]/mo) = [AMOUNT]/year
- **Total Year 1:** [AMOUNT] (+132% increase)
