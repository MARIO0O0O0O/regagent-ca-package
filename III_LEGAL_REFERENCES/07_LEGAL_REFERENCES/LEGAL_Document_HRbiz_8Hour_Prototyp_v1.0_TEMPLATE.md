...
**Cost:** [AMOUNT]-50 (essentially free)
...
```
□ Create dedicated Google account: [EMAIL]
...
□ Columns:
  ...
  - Last Name
  - Email Address
  - Position ([POSITION]/Non-[POSITION])
  - Hire Date
...
- **[POSITION] Training (2 hours):** Available as interactive online course
- **Non-[POSITION] Training (1 hour):** Separate course
- **Features:**
...
□ Section 2: Interactive Training
  ...
  - Add button: "Start [POSITION] Training (2 hours)"
...
• Course: [Harassment Prevention - [POSITION]/Employee]
...
SUPERVISORS - 2HR REQUIRED: =COUNTIF(Roster!E:E, "[POSITION]")
SUPERVISORS COMPLETED: =COUNTIFS(Roster!E:E, "[POSITION]", Roster!J:J, "<>")
...
□ [POSITION] vs. Employee designation correct ✓
...
- Google Workspace: [AMOUNT] (existing account or free Gmail)
- Autocrat: [AMOUNT] (free add-on)
- YAMM: [AMOUNT] (free tier = 50 emails/day)
- CRD Training Content: [AMOUNT] (public domain)
- Cal/OSHA Materials: [AMOUNT] (public domain)

**Optional upgrades:**
- Custom domain: [AMOUNT]/year
- Professional email: [AMOUNT]/user/month (only need 1 admin)
- Premium YAMM: [AMOUNT]/year (for tracking)
...
- [POSITION] notification for their teams
...
**For now:** This gets you 100% functional TODAY for [AMOUNT].
