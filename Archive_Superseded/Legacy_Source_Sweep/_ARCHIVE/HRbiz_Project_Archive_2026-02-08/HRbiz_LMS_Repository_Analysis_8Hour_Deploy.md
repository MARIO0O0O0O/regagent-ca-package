...
└── Lesson 1.3: Supervisor Responsibilities (15 min)
...
<div style="text-align: center; padding: 50px; font-family: Georgia, serif;">
  ...
  <div style="margin: 40px 0; font-size: 14px; text-align: left; padding: 20px; background: #f3f4f6;">
    ...
    <ul>
      ...
      <li>Supervisor reporting obligations and duties</li>
...
john.doe@company.com,John,Doe,Student,Supervisor Training,Supervisor
jane.smith@company.com,Jane,Smith,Student,Employee Training,Employee
[... 48 more rows]
```
...
Questions? Ask here or email training@hrbiz.org
...
or
Local server: $0 (use existing hardware)

SSL Certificate (Let's Encrypt): $0
Domain (hrbiz-training.com): $12/year
```

**Software:**
```
Frappe LMS: $0 (MIT license)
...
or Gmail SMTP: $0
Backup (Digital Ocean): $1/month
Monitoring (UptimeRobot): $0 (free tier)
```

**Total First Month:** $25-45
**Total First Year:** $300-550

Compare to:
- Commercial LMS: $5,000-15,000/year
- Training company: $10,000+
- Your solution: $300/year
...
Starter ($149/mo): Up to 25 employees
Pro ($299/mo): Up to 50 employees
...
| **Cost (50 users)** | $25/mo | $50/mo | $200/mo | $100/mo |
...
**If You Need Help:**
- Frappe Cloud: Managed hosting ($30-100/mo)
...
- ✅ $300/year vs. $10,000+ commercial alternatives
