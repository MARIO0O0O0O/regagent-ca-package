...
Tina Ho ("Employee") will be assisting with a comprehensive personnel file audit for 47 employees from [EFFECTIVE DATE] through [EFFECTIVE DATE] ("Project"). During this Project, Employee will have access to confidential employee information protected by federal and California state law.
...
Employee acknowledges that on **[EFFECTIVE DATE]**, Employee received 30 minutes of confidentiality training from Mario Espindola, HR Auditor, covering:
...
- Statutory damages under California CMIA: ,000 nominal OR ,000 if proven, per violation
...
This Agreement:
- Begins: **[EFFECTIVE DATE]**
- Project Ends: **[EFFECTIVE DATE]**
...
This Agreement, together with the confidentiality training received on [EFFECTIVE DATE], constitutes the entire agreement regarding confidentiality for this Project.
...
**Document Created:** [DATE] 15:09:10  
**Form Version:** 1.0
