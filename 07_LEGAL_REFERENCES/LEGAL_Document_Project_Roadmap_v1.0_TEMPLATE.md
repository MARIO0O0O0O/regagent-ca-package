...
> **Launch Target:** [EFFECTIVE DATE] (Week 6)  
> **First Client:** [COMPANY NAME] ([AMOUNT])  
...
- [ ] **DECIDE:** NJS-Firebase-SaaS (free, 2-3 weeks) vs Makerkit ([AMOUNT], 1 week)
...
**Hourly Rate:** ~[AMOUNT]/hour ([AMOUNT] ÷ 125h)  
**But:** Reusable platform = [AMOUNT] marginal cost for clients 2-10
...
### Q1 2026 (Weeks 1-12)
- **Week 6:** Button Nose payment #1 = [AMOUNT]
- **Week 10:** Client #2 (target) = [AMOUNT]
- **Week 12:** Client #3 (target) = [AMOUNT]
- **Q1 Total:** [AMOUNT]

### Q2 2026 (Weeks 13-24)
- Add 5 more clients @ [AMOUNT] = [AMOUNT]
- Convert 3 to retainers @ [AMOUNT]/mo = [AMOUNT]
- **Q2 Total:** [AMOUNT]

### Q3-Q4 2026
- Scale to 15 total clients
- 8 on retainers ([AMOUNT]/year)
- New client revenue: [AMOUNT]
- **2026 Total:** [AMOUNT]+
