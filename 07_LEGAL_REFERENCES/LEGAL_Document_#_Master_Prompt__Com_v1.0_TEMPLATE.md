...
- Cadence:
    - **Once per year**.
- Pricing:
    - Discuss the **rough numbers that were floated** (e.g., ~\[AMOUNT]/year or similar), but:
...
- Payment methodology:
    ...
    - Target **average cost ~ \[AMOUNT]/month**, but emphasize:
...
- Deliverables:
    ...
    - Q4 mini update.
- Payment methodology:
    - Pay-per-deliverable; target **~\[AMOUNT]/month average** across year.
...
- Limited compliance budget (\[AMOUNT]–\[AMOUNT]/month range)
...
| :-- | :-- | :-- | :-- |
| **Text-Only** | ~\[AMOUNT]/yr | Policies, SOPs, checklists, posters, annual compliance report | DIY businesses; budget-conscious; have internal capability to deliver training |
| **6-Month Service** | ~\[AMOUNT]/yr (\[AMOUNT]/mo avg) | All above + yearly mandated trainings + 6-month catch-up session + certificates | Most SMBs; want turnkey compliance with minimal internal effort |
| **Quarterly Service** | ~\[AMOUNT]/yr (\[AMOUNT]/mo avg) | All above + quarterly mini-updates for faster regulatory response | Compliance-sensitive industries; higher-risk businesses |
...
- **PAGA (Private Attorneys General Act)** allows employees to sue on behalf of the state for technical violations, with penalties of \[AMOUNT]–\[AMOUNT] per employee per pay period
- **Waiting time penalties** for late final paychecks: 1 day's wages for each day late (max 30 days)
- **Harassment training violations:** Up to \[AMOUNT] per failure to train
- **IIPP violations:** Citations ranging from \[AMOUNT]–\[AMOUNT]+

**Resource gap:**

- Businesses under 50 employees rarely have dedicated HR staff
- Fractional HR consultants cost \[AMOUNT]–\[AMOUNT]/hour
- Full-service employment attorneys charge \[AMOUNT]–\[AMOUNT]/hour
...
- Harassment training done 3 years ago via online vendor (\[AMOUNT])
...
| :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| **Minimum Wage** | FLSA (§6: \[AMOUNT] federal) | Labor Code §1182.12 (\[AMOUNT] state min 2026; annual adjustments) | LA City: \[AMOUNT] (2026); LA County unincorporated: \[AMOUNT] | Non-exempt employees | Ongoing (annual increases) | Pay at least applicable minimum; post wage orders | **Core candidate** |
...
- **\[AMOUNT] one-time payment** (due before Q1 delivery)

**Year 2+:**

- **\[AMOUNT] renewal** (38% discount; reflects content reuse and lighter regulatory scanning)


#### Payment Flow

1. **Client purchases** Text-Only package → pays \[AMOUNT] via Stripe
...
1. **Harassment Prevention Training**
    ...
    - Delivery: Webinar (Zoom) or in-person (Pasadena/LA County area; +\[AMOUNT] for in-person)
...
- **Month 1 (Jan):** Onboarding + intake (\[AMOUNT] fee)
- **Month 2–3 (Feb–Mar):** Main training + full pack delivered (payment due: \[AMOUNT])
- **Month 8–9 (Aug–Sep):** Catch-up training + mini-pack (payment due: \[AMOUNT])
- **Total Year 1:** \[AMOUNT] (\[AMOUNT]/month average)

**Year 2+ Timeline:**

- **Month 2–3 (Q1):** Training + refreshed pack (payment due: \[AMOUNT])
- **Month 8–9 (H2):** Catch-up training (payment due: \[AMOUNT])
- **Total Year 2+:** \[AMOUNT] (\[AMOUNT]/month average; 40% discount)
...
| :-- | :-- | :-- |
| Onboarding + Intake | Day 0 | **\[AMOUNT]** |
| Q1 Training + Full Pack | Month 2–3 | **\[AMOUNT]** |
| H2 Catch-Up Training + Mini-Pack | Month 8–9 | **\[AMOUNT]** |
| **Total Year 1** |  | **\[AMOUNT]** |
...
| Deliverable | Timing | Cost (Due Before Delivery) |
| :-- | :-- | :-- |
| Q1 Training + Refreshed Pack | Month 2–3 | **\[AMOUNT]** |
| H2 Catch-Up Training | Month 8–9 | **\[AMOUNT]** |
| **Total Year 2+** |  | **\[AMOUNT]** |

**Optional Upsells:**

- **Legal review** by counsel: +\[AMOUNT] (one-time per year; you route content to your attorney)
- **In-person training** (within 30-mile radius of Pasadena): +\[AMOUNT] per session
- **Rush delivery** (within 7 days of payment): +\[AMOUNT]
...
1. **Client selects Package 2** → Pays \[AMOUNT] onboarding
2. **Intake completed** → Client receives Calendly link to schedule Q1 training (2–4 weeks out)
3. **Invoice sent** 7 days before scheduled training: "Pay \[AMOUNT] to confirm training and receive pack"
...
11. **Invoice sent:** "Pay \[AMOUNT] for H2 catch-up training"
...
- Pay-per-deliverable with \[AMOUNT]/month Year 1 average
...
- **Month 1 (Jan):** Onboarding (\[AMOUNT])
- **Month 2–3 (Feb–Mar):** Q1 Full Training + Pack (\[AMOUNT])
- **Month 5–6 (May–Jun):** Q2 Mini-Update (\[AMOUNT])
- **Month 8–9 (Aug–Sep):** Q3 Catch-Up Training + Mini-Pack (\[AMOUNT])
- **Month 11–12 (Nov–Dec):** Q4 Mini-Update (\[AMOUNT])
- **Total Year 1:** \[AMOUNT] (\[AMOUNT]/month average)
...
- Q3 Catch-Up: \[AMOUNT]
- Q4 Mini: \[AMOUNT]
- **Total Year 2+:** \[AMOUNT] (\[AMOUNT]/month average; 33% discount)
...
| Deliverable | Timing | Cost (Due Before Delivery) |
| :-- | :-- | :-- |
| Onboarding | Day 0 | **\[AMOUNT]** |
| Q1 Full Training + Pack | Month 2–3 | **\[AMOUNT]** |
| Q2 Mini-Update | Month 5–6 | **\[AMOUNT]** |
| Q3 Catch-Up Training + Mini-Pack | Month 8–9 | **\[AMOUNT]** |
| Q4 Mini-Update | Month 11–12 | **\[AMOUNT]** |
| **Total Year 1** |  | **\[AMOUNT]** |
...
| Q1 Full Training + Pack | Month 2–3 | **\[AMOUNT]** |
| Q2 Mini-Update | Month 5–6 | **\[AMOUNT]** |
| Q3 Catch-Up Training | Month 8–9 | **\[AMOUNT]** |
| Q4 Mini-Update | Month 11–12 | **\[AMOUNT]** |
| **Total Year 2+** |  | **\[AMOUNT]** |
...
3. **Week 3:** Invoice sent to client: "Q2 Mini-Update ready; pay \[AMOUNT] to receive"
...
- Pricing at \[AMOUNT]/month Year 1 average (lower than Package 2 due to spreading training costs across 4 deliverables instead of 2)
- Year 2+ discount (33%)
...
| **Year 1 Cost (Draft)** | **\[AMOUNT]** | **\[AMOUNT]** (\[AMOUNT]/mo avg) | **\[AMOUNT]** (\[AMOUNT]/mo avg) |
| **Year 2+ Cost (Draft)** | **\[AMOUNT]** | **\[AMOUNT]** (\[AMOUNT]/mo avg) | **\[AMOUNT]** (\[AMOUNT]/mo avg) |
...
- Fractional HR consultant: \[AMOUNT]–\[AMOUNT]/month (annual: \$30k–\$60k)
...
- Waiting time penalties: 30 days × daily wage × employee count (e.g., \[AMOUNT]/day × 15 employees × 30 days = \$90k max exposure)
...
| :-- | :-- | :-- | :-- |
| **Initial intake \& client setup** | 0.5 hrs × \[AMOUNT]/hr = \[AMOUNT] | 0.5 hrs × \[AMOUNT]/hr = \[AMOUNT] | 0.5 hrs × \[AMOUNT]/hr = \[AMOUNT] |
| **Regulatory scanning** (automated + SME review) | 1 hr × \[AMOUNT]/hr = \[AMOUNT] | 1 hr × \[AMOUNT]/hr = \[AMOUNT] | 4 hrs × \[AMOUNT]/hr = \[AMOUNT] (quarterly) |
| **Content generation** (AI + SME editing) | 3 hrs × \[AMOUNT]/hr = \[AMOUNT] | 3 hrs × \[AMOUNT]/hr = \[AMOUNT] | 3 hrs × \[AMOUNT]/hr = \[AMOUNT] |
| **Training delivery** (prep + session + follow-up) | \[AMOUNT] (no training) | 6 hrs × \[AMOUNT]/hr = \[AMOUNT] (yearly + catch-up) | 6 hrs × \[AMOUNT]/hr = \[AMOUNT] |
| **Certificate generation \& admin** | \[AMOUNT] | 0.5 hrs × \[AMOUNT]/hr = \[AMOUNT] | 0.5 hrs × \[AMOUNT]/hr = \[AMOUNT] |
| **Quarterly mini-updates** | \[AMOUNT] | \[AMOUNT] | 3 hrs × \[AMOUNT]/hr × 2 quarters = \[AMOUNT] |
| **Subtotal Labor** | \[AMOUNT] | \[AMOUNT] | \[AMOUNT] |
| **Tech stack costs** (LLM API, hosting, Stripe fees) | ~\[AMOUNT]/year | ~\[AMOUNT]/year | ~\[AMOUNT]/year |
| **Legal review** (optional; if chosen) | +\[AMOUNT] pass-through | +\[AMOUNT] pass-through | +\[AMOUNT] pass-through |
| **Total Cost (before legal review)** | **~\[AMOUNT]** | **~\[AMOUNT]** | **~\[AMOUNT]** |

**Gross Margin (before legal review):**

- Package 1: (\[AMOUNT] - \[AMOUNT]) / \[AMOUNT] = **~55% margin**
- Package 2: (\[AMOUNT] - \[AMOUNT]) / \[AMOUNT] = **~78% margin**
- Package 3: (\[AMOUNT] - \[AMOUNT]) / \[AMOUNT] = **~55% margin**
...
Traditional SaaS monthly subscription (\[AMOUNT]/month for Package 2) has advantages:
...
1. **Clarity:** "I pay \[AMOUNT] in March → I get training + full pack." No mystery about what I'm paying for.
...
- 3-year LTV (assuming 75% retention Y2, 65% retention Y3): \[AMOUNT] + (0.75 × \[AMOUNT]) + (0.65 × 0.75 × \[AMOUNT]) = \[AMOUNT] + \[AMOUNT] + \[AMOUNT] = **\[AMOUNT]**

Compare to no-discount scenario (likely 50% Y2 retention, 40% Y3):

- \[AMOUNT] + (0.5 × \[AMOUNT]) + (0.4 × 0.5 × \[AMOUNT]) = \[AMOUNT] + \[AMOUNT] + \[AMOUNT] = **\[AMOUNT]**
...
```
Package 1 (Text-Only):
├── product_id: pkg1_onboarding (price: [AMOUNT]) [one-time]
└── product_id: pkg1_annual_pack (price: [AMOUNT] Y1 / [AMOUNT] Y2+) [one-time]

Package 2 (6-Month):
├── product_id: pkg2_onboarding (price: [AMOUNT]) [one-time]
├── product_id: pkg2_q1_full (price: [AMOUNT] Y1 / [AMOUNT] Y2+) [one-time]
└── product_id: pkg2_h2_catchup (price: [AMOUNT] Y1 / [AMOUNT] Y2+) [one-time]

Package 3 (Quarterly):
├── product_id: pkg3_onboarding (price: [AMOUNT]) [one-time]
├── product_id: pkg3_q1_full (price: [AMOUNT] Y1 / [AMOUNT] Y2+) [one-time]
├── product_id: pkg3_q2_mini (price: [AMOUNT] Y1 / [AMOUNT] Y2+) [one-time]
├── product_id: pkg3_q3_catchup (price: [AMOUNT] Y1 / [AMOUNT] Y2+) [one-time]
└── product_id: pkg3_q4_mini (price: [AMOUNT] Y1 / [AMOUNT] Y2+) [one-time]

Upsells:
├── upsell_legal_review (price: [AMOUNT]) [one-time]
├── upsell_in_person_training (price: [AMOUNT]) [one-time]
└── upsell_rush_delivery (price: [AMOUNT]) [one-time]
```
...
Today is the deadline for your Q1 payment ([AMOUNT]). If we don't receive payment by end of day, your delivery will be delayed by 7–10 days.
...
3. Commit to Git repo: `git commit -m "Snapshot [DATE]"`
...
```bash
git diff HEAD~1 HEAD -- labor_code/[DATE].json
```
...
├── Training Scheduled: [EFFECTIVE DATE], 10 AM PST [Join Zoom]
...
VALUES ('la-can-groom-15', 'Furry Paws Grooming', '[EMAIL]', 'dog_grooming', 15, 2, NOW());
```
...
Your next payment ([AMOUNT]) is due before your Q1 training in March.
...
- Address: [STREET ADDRESS], La Cañada Flintridge, CA 91011
...
Your Q1 pack payment ([AMOUNT]) is due by [EFFECTIVE DATE].
...
Employee Count: 15
Complaint [POSITION]: Sarah [Owner]
```
...
15. **7 days before training ([EFFECTIVE DATE]):**
    - Invoice email sent to Sarah:

```
Subject: Payment Due: Q1 Compliance Pack ([AMOUNT])
...
16. **Sarah pays \[AMOUNT]** via Stripe link ([EFFECTIVE DATE])
...
18. **24 hours before training ([EFFECTIVE DATE], 10 AM):**
    - Email sent:
...
19. **[EFFECTIVE DATE], 10:00 AM PST:**
...
💰 Cost: [AMOUNT] (due before training)
...
30. **[EFFECTIVE DATE]:**
    - Invoice sent for H2 Catch-Up: \[AMOUNT]
    - Calendly link for September training

**Business Actions:**

31. **Sarah pays \[AMOUNT]** ([EFFECTIVE DATE])
32. **Sarah schedules training** for [EFFECTIVE DATE], 2 PM PST

**Your Team Actions:**

33. **[EFFECTIVE DATE], 2:00 PM PST:**
...
-  Q1 Training + Pack: [AMOUNT] (was [AMOUNT])
-  H2 Catch-Up: [AMOUNT] (was [AMOUNT])
-  Total Year 2: [AMOUNT] (vs [AMOUNT] Year 1)
...
Renew now: [Stripe Payment Link - [AMOUNT] for Q1]
...
38. **Sarah renews:** Pays \[AMOUNT] for 2027 Q1 ([EFFECTIVE DATE])
39. **Cycle repeats** for Year 2

**Key Observations:**

- **Sarah's total 2-year spend:** \[AMOUNT] (Y1) + \[AMOUNT] (Y2) = **\[AMOUNT]**
- **Compare to alternatives:**
    - Fractional HR (2 years): \$60k–\$120k
    - One-time consultant + annual training vendor: \$10k (Y1) + \$5k (Y2) = \$15k
    - **Sarah saves \[AMOUNT]–\[AMOUNT]** over 2 years
...
[Business Discovers Service]
         ↓
[Purchases Package ([AMOUNT] onboarding)]
         ↓
...
1. Client selects "Legal Review" add-on (+\[AMOUNT])
...
Fee: [AMOUNT]/hour, estimated 2–3 hours per pack review.
```
...
├── 2026q1/
│   ├── harassment_policy.md (approved [DATE] by mario)
│   ├── wvpp_plan.md (approved [DATE] by mario)
│   └── ...
├── 2026h2/
...
| **Webinars are sufficient (vs in-person)** | Do clients value in-person enough to pay +\[AMOUNT]? | Track in-person upsell take rate | ⏳ **Unvalidated** |
...
**Cost estimate:** ~\[AMOUNT]–\[AMOUNT]/word for professional translation; full policy pack (~20k words) = \$2k–\$4k one-time, then incremental for updates.
...
3. **Pilot Client Acquisition:**
    - Recruit 3–5 clients via:
        ...
        - LinkedIn outreach
    - Offer **50% discount** for pilot participation (\[AMOUNT] → \[AMOUNT] for Package 2 Year 1)
...
5. **Legal Setup:**
    - Consult CA employment attorney (2-hour session: \[AMOUNT]–\[AMOUNT])
