...
6. You upsell monthly HR advisory retainer ([AMOUNT]-2000/mo)
...
- [POSITION] count vs non-supervisor count
- Upload company logo
...
- Department
- Hire Date*
- [POSITION] Status* ([POSITION] / Non-[POSITION])
...
- Generous free tier ([AMOUNT]-25/month for small clients)
