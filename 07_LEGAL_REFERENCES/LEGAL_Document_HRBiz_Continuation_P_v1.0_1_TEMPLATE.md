...
- **Starter:** [AMOUNT]/month (up to 25 employees)
- **Professional:** [AMOUNT]/month (up to 100 employees)
...
- ✅ [POSITION] training outline (2 hours)
...
**Module 4: [POSITION] Responsibilities (20 minutes - Supervisors Only)**
...
**Cost:** [AMOUNT]-100/month (hosting + tools)
...
**Estimated Initial Investment:** [AMOUNT]-5,000 (if using freelancers) or [AMOUNT]-500 (if DIY)  
